...
<div class="container">
    <div class="row">
        ...
        <a href="pengarang_add.php" class="btn btn-primary" role="button">Add New Pengarang</a><br/><br/>
            ...
            <?php  
                while($pengarang_data = mysqli_fetch_array($pengarang)) {         
                    ...
                    echo "<td><a class='btn btn-warning' href='pengarang_edit.php?id_pengarang=$pengarang_data[id_pengarang]'>Edit</a> | <a class='btn btn-danger' href='pengarang_delete.php?id_pengarang=$pengarang_data[id_pengarang]'>Delete</a></td></tr>";        
                }
            ?>
            </table>
        </div>
