...
<body>
	<div class="container">
		<div class="row">
			...
			<a href="index.php" class="btn btn-info" role="button">Go to Home</a>
	<br/><br/>
	...
	<form action="edit.php?isbn=<?php echo $isbn; ?>" method="post">
		<table width="25%" border="0">
			...
			<tr> 
				<td>Judul</td>
				<td><input required type="text" name="judul" value="<?php echo $judul; ?>"></td>
			</tr>
			<tr> 
				<td>Tahun</td>
				<td><input required type="text" name="tahun" value="<?php echo $tahun; ?>"></td>
			</tr>
			<tr> 
				<td>Penerbit</td>
				<td>
			...
			<tr> 
				<td>Qty Stok</td>
				<td><input required type="text" name="qty_stok" value="<?php echo $qty_stok; ?>"></td>
			</tr>
			<tr> 
				<td>Harga Pinjam</td>
				<td><input required type="text" name="harga_pinjam" value="<?php echo $harga_pinjam; ?>"></td>
			</tr>
			<tr> 
				<td></td>
	...
	<?php
		...
		if(isset($_POST['update'])) {
			...
			try {
				...
				// Proses hasil query jika query berhasil dieksekusi
				$mysqli->close();
