...
<body class = "container mt-3">
	...
	<form action="penerbit_edit.php?id_penerbit=<?php echo $id_penerbit; ?>" method="post">
		<table width="25%" border="0">	
			<tr> 
				<td>ID Penerbit</td>
				<td><input type="text" name="id_penerbit" value="<?php echo $id_penerbit; ?>" disabled></td>
			</tr>
			<tr> 
	...
	<?php
		...
		if(isset($_POST['update'])) {
			...
			$result = mysqli_query($mysqli, "UPDATE penerbit SET nama_penerbit = '$nama_update', email = '$email', telp = '$telp', alamat = '$alamat' WHERE id_penerbit = '$id_penerbit';");
