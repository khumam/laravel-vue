              ...
              <div class="card">
                  <div class="card-header">
                    <div class="row">
                      ...
                      <div class="col-md-6"><a href="{{ route('author.create') }}" type="button" class="btn btn-primary float-right">
                          ...
                          <tr>
                            ...
                            <td>
                              <div class="row">
                                ...
                                <div class="col-md-6">
                                  <form action="{{ route('author.destroy', ['author' => $author->id]) }}" method="post" class="d-inline">
                                    @method('delete')
                                    @csrf
